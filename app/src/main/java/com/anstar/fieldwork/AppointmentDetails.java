...
public class AppointmentDetails extends BaseActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setting = PreferenceManager
				.getDefaultSharedPreferences(AppointmentDetails.this);
		...
		edtStartedat.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				if (event != null && event.getAction() == MotionEvent.ACTION_UP) {
					...
					new TimePickerDialog(AppointmentDetails.this, time1,
		...
		edtFinisedat.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				if (event != null && event.getAction() == MotionEvent.ACTION_UP) {
					...
					new TimePickerDialog(AppointmentDetails.this, time2,
	...
	public void onClick(View v) {
		if (v == btnSave) {
			...
			if (edtStartedat.getText().toString().length() < 1) {
				...
				AppointmentInfo.saveAppointementNew(AppointmentDetails.this,
			...
			Intent i = new Intent(AppointmentDetails.this, PhotosActivity.class);
			i.putExtra(Const.Appointment_Id, appointment_id);
			startActivity(i);
			...
			holder.rl.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (info.Type.equalsIgnoreCase(ContactType.Phone.toString())) {
						Utils.callPhone(info.Value, AppointmentDetails.this);
					}
					if (info.Type.equalsIgnoreCase(ContactType.Email.toString())) {
						Utils.sendEmail(info.Value, AppointmentDetails.this);
					}
				}
			});
